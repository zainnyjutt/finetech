...
<head>
    ...
    <link rel="stylesheet" href="../view/students_fees.css">
...
?>
        ...
        <table id="fees-table" class="fees-table">
            ...
            <tbody>
                ...
                $sql = "SELECT `id`, `name`, `course`, `contact`,`cnic`, `fees`, `paid` FROM students LIMIT $startRecord, $studentsPerPage";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<tr>
                                ...
                                <td>
                                    <a class='add-payment-button' href='student_payment.php?id=" . $row['id'] . "'>Add Payment</a>
                                </td>
                                <!-- students_fees.php -->

                                <td>
                                 <a class='add-payment-button' style='background-color:blue;' target='_blank' href='print_student_fees.php?id=" . $row['id'] . "'>Print Report</a>
    ...
    $conn = mysqli_connect($host, $username, $password, $database);
    $totalStudents = mysqli_query($conn, "SELECT COUNT(*) FROM students");

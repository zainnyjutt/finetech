    ...
    <div class="content">
        ...
        <div class="card-container">
            <div class="card">
                ...
                $sql = "SELECT COUNT(*) as total_students FROM seminars";
            ...
            <div class="card">
                <h2>Add Seminar</h2>
                <a href="add_seminar.php">Add Seminar</a>
            </div>
...
?>
            <table>
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM seminars LIMIT $startRecord, $studentsPerPage";
                    $result = mysqli_query($conn, $sql);
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        ...
                        echo '<tr><td colspan="4">No Seminar records found!</td></tr>';
                    }
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#search-input').on('input', function() {
                ...
                $.ajax({
                    url: 'search/search_seminars.php',
                    method: 'POST',

...
$query_dates = "SELECT DISTINCT attendance_date FROM student_attendance";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['date'])) {
    ...
    $selected_course = isset($_GET['course']) ? urldecode($_GET['course']) : ''; // Retrieve course from URL parameter
    $query_attendance = "SELECT * FROM student_attendance WHERE attendance_date = '$selected_date' AND course = '$selected_course'";
...
<head>
    ...
    <div class="container">
        <div class="header">
            <h1 style="color:#f9c013;">Student Attendance</h1>
    ...
    <a href="mark_course_attendance.php?course=<?php echo urlencode($_GET['course']); ?>" class="button mark-attendance">Mark Attendance</a>
</form>

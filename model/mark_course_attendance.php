...
$course_name = isset($_GET['course']) ? urldecode($_GET['course']) : '';

// Fetch student data for the selected course
$query_students = "SELECT * FROM students WHERE course = '$course_name' AND status = 'Enrolled'";
...
$query_existing_attendance = "SELECT * FROM student_attendance WHERE attendance_date = '$attendance_date' AND course = '$course_name'";
...
<html lang="en">
<head>
    <!-- Your head section with meta tags and styles -->
</head>
<body>
...
<div class="header">
    ...
    <div class="container2">
        ...
        <div class="container2">
            <!-- Attendance Form -->
            <form method="post" action="../controller/insert_course_attendance.php">

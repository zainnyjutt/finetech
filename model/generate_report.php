...
<head>
    ...
    <title>Student Report</title>
       <script src="PHPExcel/PHPExcel.js"></script>
...
include('sidebar.php');
  ...
  <h1 class="header111">STUDENTS REPORT</h1>
    <div class="content1">
        ...
        if (
            ...
            echo "<h2 class='print-style'>STUDENT REPORT for {$student['name']}</h2>";
            echo "<p>CNIC: {$student['cnic']}</p>";
            echo "<p>E-MAIL: {$student['email']}</p>";
            echo "<p>CONTACT: {$student['contact']}</p>";
            echo "<p>TOTAL FEES: {$student['fees']}</p>";
            echo "<p>FEES PAID: {$student['paid']}</p>";
...
<script>
    function exportToExcel() {
        ...
        window.location.href = 'download_excel.php' + window.location.search;
    }
</script>
</html>

...
<div class="content">
    ...
    <div>
        ...
        <a href="add_expense_category.php"><button class="adc">Add Expense Category</button></a>
        ...
        <table border="1">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td class='update-cell'><a href='update_expense_category.php?id=" . $row["id"] . "'><button class='update-button'>Update</button></a></td>";
                    echo "<td class='delete-cell'>
                            <form action='../controller/delete_expense_category.php' method='POST'>

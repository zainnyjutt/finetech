    ...
    <div class="content">
        ...
        <div class="card-container">
            <div class="card">
                ...
                $sql = "SELECT COUNT(*) as total_students FROM userdata";
...
?>
            <table>
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM userdata LIMIT $startRecord, $studentsPerPage";
                    $result = mysqli_query($conn, $sql);
    ...
    $conn = mysqli_connect($host, $username, $password, $database);
    $totalStudents = mysqli_query($conn, "SELECT COUNT(*) FROM userdata");

...
<div class="content">
    ...
    <div>
        <h2>Expense List</h2>
        <a href="add_expense.php"><button class="add-expense-btn">Add New Expense</button></a>
        ...
        <table border="1">
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . $row["date"] . "</td>";
                    echo "<td><a href='update_expense.php?id=" . $row["id"] . "'><button class='update1'>Update</button></a></td>";
                    echo "<td><a href='../controller/delete_expense.php?id=" . $row["id"] . "'><button class='delete1'>Delete</button></a></td>";
                    echo "</tr>";

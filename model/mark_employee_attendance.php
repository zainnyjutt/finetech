...
$query_students = "SELECT * FROM employees  WHERE status = 'Joined'";;
...
$query_existing_attendance = "SELECT * FROM employee_attendance WHERE attendance_date = '$attendance_date'";
...
<div class="header">
    ...
    <div class="container2">
        ...
        <div class="container2">
            <!-- Attendance Form -->
            <form method="post" action="../controller/insert_employee_attendance.php">

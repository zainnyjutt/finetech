...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['date'])) {
    ...
    $query_attendance = "SELECT * FROM student_attendance WHERE attendance_date = '$selected_date'";
...
<head>
    ...
    <a href="mark_attendance.php" class="button mark-attendance">Mark Attendance</a>
</form>
